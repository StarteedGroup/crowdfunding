...
class Reward extends ResourceBase
{
     ...
     *
     * @param CampaignResource $campaign The Starteed Self campaign resource that we want to lookup for rewards
     */
    ...
    /**
     * Retrieve all the rewards related to Starteed Self campaign
     *
