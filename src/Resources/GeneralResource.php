...
use Starteed\GeneralEndpoint;
use Starteed\SelfCrowdfunding;
use Starteed\Responses\StarteedResponse;
use Starteed\Contracts\RequestableInterface;

class GeneralResource extends BaseResource implements RequestableInterface
{
    /**
     * @var \Starteed\GeneralEndpoint
     */
    protected $endpoint;
     ...
     *
     * @param \Starteed\GeneralEndpoint            $generalEndpoint
     * @param \Starteed\Responses\StarteedResponse $response
     */
    public function __construct(GeneralEndpoint $generalEndpoint, StarteedResponse $response)
    {
